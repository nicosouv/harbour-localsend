...
TRANSLATIONS = {
    ...
    "Stored data": {
        "en": "Stored data", "fr": "Données stockées",
        "de": "Gespeicherte Daten", "es": "Datos guardados",
        "fi": "Tallennetut tiedot", "it": "Dati memorizzati",
        "nb_NO": "Lagrede data",
    },
    "Encrypted with a stored key": {
        "en": "Encrypted with a stored key",
        "fr": "Chiffrées avec une clé en trousseau",
        "de": "Mit hinterlegtem Schlüssel verschlüsselt",
        "es": "Cifrados con una clave en el almacén",
        "fi": "Salattu avainsäilöön talletetulla avaimella",
        "it": "Cifrati con una chiave nel portachiavi",
        "nb_NO": "Kryptert med en lagret nøkkel",
    },
    "Owner-only files": {
        "en": "Owner-only files", "fr": "Fichiers réservés au propriétaire",
        "de": "Nur für den Eigentümer lesbar",
        "es": "Archivos solo para el propietario",
        "fi": "Vain omistajan luettavat tiedostot",
        "it": "File leggibili solo dal proprietario",
        "nb_NO": "Filer kun for eieren",
    },
    "HTTPS (encrypted)": {
